...
# Transformaing the Date and Time variables from characters into objects of type Date and POSIXlt respectively
...
# Composing for many graphs

> par(mfrow=c(2,2))

# Calling the basic plot function to build 4 plots
